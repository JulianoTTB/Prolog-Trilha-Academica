% Perfil: Aluno com forte inclinação para inteligência artificial.

resposta(1, s). % Resposta para pergunta 1
resposta(2, n). % Resposta para pergunta 2
resposta(3, s). % Resposta para pergunta 3
